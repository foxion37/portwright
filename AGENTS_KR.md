...
의도한 설계입니다. 원본 저장소에는 절대 공개되면 안 되는 개인 메모가 함께 있어서, 게시는 미러링이 아니라 걸러낸 빌드입니다. 그래서 기여 방식이 다릅니다. [CONTRIBUTING.md](CONTRIBUTING.md)를 보세요. 좋은 Pull Request는 원본 저장소로 옮겨 적은 뒤 다음 내보내기로 여기 반영됩니다. 내용은 남고 커밋은 남지 않습니다.
...
절차는 필요해서 캐시된 것이지 미리 적어 둔 것이 아닙니다. 아무도 쓰지 않은 도구의 절차를 추가하는 PR은 범위 밖입니다.
